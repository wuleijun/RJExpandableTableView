#
#  Be sure to run `pod spec lint RJExpandableTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "rayjuneWu"
  # s.authors            = { "rayjuneWu" => "wuleijun8@gmail.com" }
  ...
  s.source_files  = "RJExpandableTableView.swift,RJExpandableTableViewCell.swift"
